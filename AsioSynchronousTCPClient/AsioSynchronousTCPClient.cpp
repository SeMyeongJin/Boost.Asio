// AsioSynchronousTCPClient.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	if (connect_error)
	{
		std::cout << "연결 실패 : " << connect_error.value() << ", Message : " << connect_error.message() << std::endl;
